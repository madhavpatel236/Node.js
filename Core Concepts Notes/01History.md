...
- Node.js is a cross platform, open source javascript runtime environment which is built on `chrome's V8 javascript engine.`
...
- `Apache HTTP Server was a blocking server, so Ryan wanted to create a non-
blocking server, which is why Node.js is a non-blocking I/O.The advantage of
...
of NPM.
    - In 2014, a developer named `Fedor` created a fork of Node.js called io.js, which
led to controversy within the company. As a result, 3 to 4 developers began
maintaining the io.js branch.
